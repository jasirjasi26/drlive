      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            ...
            Pin(size: 559.2, start: 72.4),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(size: 265.0, start: 28.0),
                ...
                Pinned.fromPins(
                  Pin(size: 191.5, start: 31.5),
                  Pin(size: 14.0, start: 48.0),
                  child: Stack(
                    children: <Widget>[
                      Pinned.fromPins(
                ...
                Pinned.fromPins(
                  Pin(size: 56.0, middle: 0.5639),
                  Pin(size: 22.0, start: 88.2),
                  child: Text(
                    'Consultation\n Method',
                    style: TextStyle(
                      fontFamily: 'Arial',
                ...
                Pinned.fromPins(
                  Pin(start: 14.0, end: 7.0),
                  Pin(size: 10.0, middle: 0.2807),
                  child: Stack(
                    children: <Widget>[
                      Pinned.fromPins(
                ...
                Pinned.fromPins(
                  Pin(size: 12.5, start: 38.3),
                  Pin(size: 12.5, start: 12.4),
                  child:
                      // Adobe XD layer: 'surface1' (group)
                      Stack(
                    children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 92.0, start: 52.0),
            Pin(size: 17.0, start: 31.0),
            child: PageLink(
              links: [
                PageLinkInfo(
                  ease: Curves.easeOut,
                  duration: 0.3,
                 // pageBuilder: () => AppointmentHistory1(),
                ),
              ],
              child: Text(
                'Active History',
...
const String _svg_xu7rg2 =
    '<svg viewBox="190.0 56.5 87.0 1.0" ><path transform="translate(190.0, 56.5)" d="M 0 0 L 87 0" fill="none" stroke="#f6b2e1" stroke-width="2" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
