...
class DoctorsData {
  Future<Doctors> fetchAlbum() async {
    ...
    final response = await http.get('${AppConfig.BASE_URL}doctors', headers: {
  ...
  Future<FindDoctor> fetchDoctor(int id) async {
    ...
    final response = await http.post('${AppConfig.BASE_URL}finddoctors',
        headers: {
          'Content-Type': 'application/json',
          'Accept': 'application/json',
          'Authorization': 'Bearer $token',
  ...
  Future<bool> takeAppoinment(String d_id, String p_id, String category,
    ...
    final response = await http.post('${AppConfig.BASE_URL}appointment/submit',
        headers: {
          'Content-Type': 'application/json',
          'Accept': 'application/json',
          'Authorization': 'Bearer $token',
