...
class History {
  Future<ActiveDoctorHistory> activeDoctorData(String doctor_id) async {
    ...
    final response = await http.post(
        '${AppConfig.BASE_URL}doctor/active/history',
        body: body,
        headers: {
  ...
  Future<ActivePatientHistory> activePatientData(String patient_id) async {
    ...
    var body = json.encode(data);
    final response = await http.post(
        '${AppConfig.BASE_URL}patient/active/history',
        body: body,
        headers: {
          'Content-Type': 'application/json',
          'Accept': 'application/json',
  ...
  ///past History//
  Future<PastDoctorHistory> pastDoctorData(String doctor_id,String from,String to,String search) async {
    String token = access_token.value;
    Map data = {
      'doctor_id': doctor_id,
      'from_date':from,
    ...
    final response = await http
        .post('${AppConfig.BASE_URL}doctor/past/history', body: body, headers: {
      'Content-Type': 'application/json',
      'Accept': 'application/json',
      'Authorization': 'Bearer $token',
    });
  ...
  Future<PastPatientHistory> pastPatientData(String patient_id,String from,String to,String search) async {
    String token = access_token.value;
    Map data = {
      'patient_id': patient_id,
      'from_date':from,
    ...
    var body = json.encode(data);
    final response = await http.post(
        '${AppConfig.BASE_URL}patient/past/history',
        body: body,
        headers: {
          'Content-Type': 'application/json',
          'Accept': 'application/json',
