                    ...
                    if (i != 2)
                      ...
                      return DateRow(
                        ...
                        selectedDayOfWeekStyle: TextStyle(
                            ...
                            fontSize: 18,
                            fontWeight: FontWeight.bold),
                        selectedMonthStyle: TextStyle(color: Colors.white, fontSize: 0),
                        width: width,
                      );
                  },
                ),
                ...
                Center(
                  child: Padding(
                    ...
                    child: Container(
                      ...
                      child: Text(
                        'There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in someform, by injected humour   There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour There are many variations of passages of Lorem Ipsum available, but the majority .',
                        style: TextStyle(
                          fontFamily: 'Arial',
                          fontSize: 14,
                          color: const Color(0xff858585),
