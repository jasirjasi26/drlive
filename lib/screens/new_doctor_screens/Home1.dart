...
import 'dart:async';
import 'package:active_ecommerce_flutter/screens/new_doctor_screens/notification_page.dart';
...
class Home1 extends StatefulWidget {
  Home1({Key key, this.title, this.show_back_button = false}) : super(key: key);
...
class _HomeState extends State<Home1> {
                    ...
                    child: Text.rich(
                      TextSpan(
                        ...
                        children: [
                          ...
                          TextSpan(
                            text: '      Dr.' + user_name.value.toUpperCase(),
                            style: TextStyle(
                              fontFamily: 'Arial',
                              fontSize: 26,
                              color: const Color(0xff858585),
                            ...
                            GestureDetector(
                              onTap: () {
                                Navigator.push(context,
                                  ...
                                  return PatientsList(is_base_category: true,);
                                }));
                              },
                              child: Text(
                                'See All',
  ...
  buildDoctorOnlineRow() {
    return FutureBuilder<Appointments>(
      ...
      builder: (context, snapshot) {
        if (snapshot.hasData) {
                    ...
                    children: [
                      Padding(
                        ...
                        child: Container(
                          ...
                          child:
                              snapshot.data.appointments[index].patient.image !=
                                      null
                                  ? Image.network('${AppConfig.IMAGE_URL}' +
                                      snapshot.data.appointments[index].patient
                                          .image)
                                  : Container(),
                        ),
                      ),
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                snapshot.data.appointments[index].patient.firstName
                                    .toUpperCase(),
                                style: TextStyle(
                                  fontFamily: 'Arial',
                                  fontSize: 14,
          ...
          return Container(height:100,child: Center(child: Text('No Appointments...')));
        }
                        ...
                        Pinned.fromPins(
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                              ...
                              border: Border.all(
                                  width: 1.0, color: const Color(0xff6b0772)),
                            ),
                          ),
                        ),
                        Pinned.fromPins(
