        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: Text("Gender",
                  style: TextStyle(fontSize: 15, color: Color(0xff6b0772))),
            ),
            Row(
              children: [
                Radio(
                      ...
                      Row(
                        children: [
                          Padding(
                            ...
                            child: Text("City",
                                style: TextStyle(
                                    fontSize: 15, color: Color(0xff6b0772))),
                          ),
                        ],
                      ),
                      Container(
            ...
            Card(
              child: Container(
                ...
                child: DropdownButton<String>(
                  isExpanded: true,
                  isDense: true,
                  items: <String>['Cardiothoracic Surgeon', 'Cardiothoracic Surgeon', 'Cardiothoracic Surgeon'].map((String value) {
                    return DropdownMenuItem<String>(
                      value: value,
                      child: Text(value),
                    );
