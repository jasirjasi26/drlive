...
class DoctorsListState extends State<PatientsList> {
  ...
  String to = "2022-02-10";
  String search = "";

  @override
  void initState() {
    super.initState();
    fetchAppointment = History().activeDoctorData("1");
  ...
  buildCategoryList() {
    return Column(
      children: [
        ...
        FutureBuilder<ActiveDoctorHistory>(
                        ...
                        children: [
                          ...
                          index > 0
                              ? snapshot.data.appointments[index].date.month !=
                                      snapshot.data.appointments[index - 1].date
                                          .month
                                  ? Row(
                                      children: [
                                        Padding(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return Padding(
                          ...
                          child: Card(
                            color:
                                index.isEven ? Colors.white : Color(0xfff3c306),
                            shape: RoundedRectangleBorder(
                              // side: new BorderSide(color: Colors.white, width: 1.0),
                              borderRadius: BorderRadius.circular(5.0),
                            ),
